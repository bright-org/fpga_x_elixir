...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s_axi4_mem} \
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {178.356} \
    CONFIG.CLKOUT1_PHASE_ERROR {349.978} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {333.0} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {84.500} \
...
\
  ...
  connect_bd_intf_net -intf_net S_AXI_HPC0_FPD_0_1 [get_bd_intf_ports s_axi4_mem] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXI_HPC0_FPD_0_1] [get_bd_intf_ports s_axi4_mem] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_ports m_axi4l_peri_aclk] [get_bd_ports s_axi4_mem_aclk] [get_bd_pins ila_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_ports m_axi4l_peri_aresetn] [get_bd_ports s_axi4_mem_aresetn]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces s_axi4_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces s_axi4_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
